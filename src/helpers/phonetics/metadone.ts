/**
 * From https://github.com/words/metaphone
 ...
 * @returns {string}
 */
export function metaphone(value: string) {
  let phonized = ''
  let index = 0
  /** @type {number} */
  let skip
   ...
   * @param {number} offset
   */
  function atFactory(offset: number) {
    return function () {
      return at(offset)
    }
  }
 ...
 * @returns {boolean}
 */
function noGhToF(character: string) {
 ...
 * @returns {boolean}
 */
function soft(character: string) {
  character = char(character)
 ...
 * @returns {boolean}
 */
function vowel(character: string) {
  character = char(character)
 ...
 * @returns {boolean}
 */
function dipthongH(character: string) {
  character = char(character)
 ...
 * @returns {boolean}
 */
function alpha(character: string) {
 ...
 * @returns {string}
 */
function char(character: string) {
