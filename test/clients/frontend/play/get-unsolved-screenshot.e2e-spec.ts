...
import { GetUnsolvedScreenshotControllerRequest } from '../../../../src/modules/clients/frontend/play/controllers/get-unsolved-screenshot.controller'
...
describe('POST /frontend/play/get-unsolved-screenshot', () => {
  ...
  describe('Unauthenticated', () => {
    ...
    it('should return a random unseen screenshot', async () => {
  ...
  describe('Authenticated', () => {
    ...
    it('should return a random unsolved screenshot', async () => {
      await prisma.screenshot.create({
        data: {
          ...newValidatedScreenshot(),
          addedBy: { create: newUser() },
      ...
      // Should not have returned the unvalidated screenshot
      expect(body.id).not.toEqual(unvalidatedScreenshot.id)
    })
